...
Best case we throw our 1000 piece puzzle on the floor and pick up one piece after another while ciphering; thus, we enforing that the puzzle can only be solved by repeating the exact same steps.
